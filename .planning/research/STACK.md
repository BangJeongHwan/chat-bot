...
**Confidence:** HIGH (core stack is locked by project constraints; versions verified against official release pages)
...
dependencies {
    ...
    // Kotlin JDSL (type-safe JPA queries)
    implementation("com.linecorp.kotlin-jdsl:spring-data-jpa-support:3.x.x")
...
**Phase 1-3 (MVP — REST polling, no WebSocket):**
...
**Phase 5 (Scale — 10,000+ concurrent users):**
...
---
*Stack research for: 모의투자 플랫폼 (StockBot)*
*Researched: 2026-03-26*
